package com.thinking.machines.orm.framework;
...
//sb.append("package com.thinking.machines.orm.pojo;\n");
...
//System.out.println(entry1.getKey()+", "+ entry1.getValue().typeName+", "+entry1.getValue().isPrimaryKey); 
} 
sb.append("}");
